...
- **Загрузка фото:** Создание и получение фото (80%)
- **Заявки на усыновление:** Создание, одобрение, отклонение (100%)
- **Ролевая система:** Проверка прав доступа (60%)

### Основные модули и покрытие:
1. **UserRepository** - 100% (6 тестов)
2. **AnimalRepository** - 100% (6 тестов)
3. **AdoptionRepository** - 100% (7 тестов)
